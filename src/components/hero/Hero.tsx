      ...
      <div class="max-w-[1270px] mx-auto px-8 md:px-20 lg-px-0">
        <div class="flex py-52 sm:py-96">
          <div class="grid lg:grid-cols-2 m-auto">
            <div class="lg:pr-10">
              <h1 class="font-bold text-transparent text-2xl sm:text-3xl md:text-5xl bg-clip-text bg-gradient-to-b from-blue-700 to-blue-200">
                {props.title}
              </h1>
              <p class="py-10 md:py-20 text-sm sm:text-lg lg:pr-20">
                {props.text}
              </p>
              <div class="flex justify-center lg:justify-start">
                ...
                <a
                  ...
                  rel="noreferrer"
                >
                  <button class={buttonText1}>{props.buttonText2}</button>
                </a>
              </div>
            </div>
            <div class="pt-10 lg:pt-0 flex justify-center lg:justify-end lg:mx-0 px-10 sm:px-20 lg:px-0">
              <img
                src={props.image}
                alt="hero image"
                class="lg:absolute  object-contain"
                width={480}
                height={480}
              />
            </div>
